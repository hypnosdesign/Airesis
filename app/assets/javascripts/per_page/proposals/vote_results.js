window.ProposalsVoteResults = {
  init: function() {
    ...
    return $('[data-plot]').each(function() {
      var dataa = [
      ...
      return $(document).on('opened.fndtn.reveal', '[data-reveal]', function() {
        return ProposalsVoteResults.plot1.replot();
      });
    });
  },
  showVoteResults: function() {
    ...
    return $('#cast_table_wrapper label').css('font-weight', 'normal').css('font-size', '12px');
  }
};
